      ...
      <Card className="w-full max-w-md border-none shadow-xl shadow-slate-200">
        <CardHeader className="space-y-4 flex flex-col items-center">
          ...
          <div className="text-center">
            ...
            <CardDescription>Enter your credentials to access your health wallet</CardDescription>
          </div>
        </CardHeader>
        <form action={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <p className="text-sm text-slate-500">
              ...
              <Link href="/auth/signup" className="text-rose-500 font-semibold hover:underline">
                Sign Up
              </Link>
            </p>
          </CardFooter>
